...
function Testimonials(props){
    ...
    return(
        ...
        className="bg-violet-400 hover:bg-violet-500 transition-all duration-200 cuesor-pointer px-10 py-2 rounded-md font-bold text-white text=lg w-[170px] mt-2 mx-auto">
            Surprise Me
        </div>
        </div>
    )
